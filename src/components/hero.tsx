      ...
      <div className="relative z-10 space-y-10">
        <div className="grid gap-10 lg:grid-cols-[1.1fr_0.9fr]">
          ...
          <div className="relative">
            <div className="absolute inset-6 rounded-[28px] bg-linear-to-br from-[#f97316] to-[#c026d3] blur-3xl opacity-50" />
            <div className="relative overflow-hidden rounded-[28px] border border-white/10 bg-white/5 p-8 backdrop-blur">
              <div className="flex flex-col items-center text-center">
                <div className="relative h-56 w-56 overflow-hidden rounded-full border border-white/10">
                  <Image
